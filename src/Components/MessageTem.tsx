  ...
  return (
    <div className='flex flex-col'>
      ...
      <div className='flex space-x-2 items-center w-[100%] mt-1'>
        <span className='h-10 w-10 rounded-full flex justify-center items-center bg-blue-500 self-end'>{receiverUser.name? receiverUser.name[0] : ''}</span>
        <h1 className='w-[90%] bg-gray-100 p-2 rounded-md'>{message.message? message.message: message.img}</h1>
      </div>
    </div>
  );
};
